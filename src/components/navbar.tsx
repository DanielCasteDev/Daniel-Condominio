        ...
        <ul className="space-y-2">
          ...
          <li>
            <Link
              ...
              className="flex items-center px-4 py-3 hover:bg-gray-700 hover:text-white transition-all duration-300 rounded-lg group"
            >
              <DocumentTextIcon className="h-6 w-6 mr-4 text-green-400 group-hover:text-white" />
          ...
          <li>
            <Link
              ...
              className="flex items-center px-4 py-3 hover:bg-gray-700 hover:text-white transition-all duration-300 rounded-lg group"
            >
              <LockClosedIcon className="h-6 w-6 mr-4 text-purple-400 group-hover:text-white" />
          ...
          <li>
            <Link
              ...
              className="flex items-center px-4 py-3 hover:bg-gray-700 hover:text-white transition-all duration-300 rounded-lg group"
            >
              <CurrencyDollarIcon className="h-6 w-6 mr-4 text-yellow-400 group-hover:text-white" />
